object Form: TForm
  ...
  object PageControl1: TcyTabControl
    Left = 0
    Height = 350
    Top = 0
    Width = 611
    HotTrack = True
    Options = [nboShowCloseButtons, nboHidePageListPopup, nboDoChangeOnSetIndex]
    TabOrder = 1
    ActiveTabColors.FromColor = 16667243
    ActiveTabColors.SpeedPercent = 90
    ActiveTabColors.ToColor = clBtnFace
    InactiveTabColors.FromColor = 10415909
    InactiveTabColors.SpeedPercent = 100
    InactiveTabColors.ToColor = 11114
  end
  object SynHTMLSyn1: TSynHTMLSyn
    DefaultFilter = 'Documento HTML (*.htm,*.html)|*.htm;*.html'
    Enabled = False
    Left = 508
    Top = 31
  end
  object SynXMLSyn1: TSynXMLSyn
    DefaultFilter = 'Documento XML (*.xml,*.xsd,*.xsl,*.xslt,*.dtd)|*.xml;*.xsd;*.xsl;*.xslt;*.dtd'
    Enabled = False
